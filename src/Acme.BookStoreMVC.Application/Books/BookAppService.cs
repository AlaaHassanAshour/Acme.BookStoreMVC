...
//[Authorize(BookStoreMVCPermissions.Books.Default)]
    ...
    IBookAppService //implement the IBookAppService
{
        ...
        : base(repository)
    {
        ...
        GetPolicyName = BookStoreMVCPermissions.Books.Default;
        GetListPolicyName = BookStoreMVCPermissions.Books.Default;
        CreatePolicyName = BookStoreMVCPermissions.Books.Create;
        UpdatePolicyName = BookStoreMVCPermissions.Books.Edit;
        DeletePolicyName = BookStoreMVCPermissions.Books.Delete;
    }
