...
namespace Acme.BookStoreMVC.Migrations
{
    ...
    [Migration("20230828092107_Added_BookTranslation")]
    partial class AddedBookTranslation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.BookStoreMVC.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Acme.BookStoreMVC.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.BookStoreMVC.Books.BookTranslation", b =>
                {
                    ...
                    b.HasKey("BookId", "Language");

                    b.ToTable("AppBookTranslations", (string)null);
                });

            modelBuilder.Entity("Acme.BookStoreMVC.TodoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.BookStoreMVC.Books.Book", b =>
                {
                    b.HasOne("Acme.BookStoreMVC.Authors.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.BookStoreMVC.Books.BookTranslation", b =>
                {
                    b.HasOne("Acme.BookStoreMVC.Books.Book", null)
